...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 荣誉奖励 <span
        class="c-gray en">&gt;</span> 荣誉称号 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px"
...
<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a
        href="javascript:;" onclick="member_add('添加荣誉称号信息','<?php echo U("Honour/add");?>','','510')" class="btn btn-primary radius"><i
        class="Hui-iconfont">&#xe600;</i> 添加荣誉称号信息</a></span> </div>
<div class="mt-20">
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td><?php if($row["file"] == '' ): ?>未上传 <?php else: ?> <a href="<?php echo U('Honour/downfile',array('id'=>$row['id']));?>">下载</a><?php endif; ?></td>
                <td><?php echo ($row["remark"]); ?></td>
                <!--<td class="td-status"><span class="label label-success radius">已发布</span></td>-->
                <td class="f-14 td-manage">
                    <a title="编辑" href="javascript:;" onclick="member_edit('课设信息修改','<?php echo U("Honour/edit",array("id"=>$row["id"]));?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
