...
<title>添加毕设信息 - H-ui.admin v3.1</title>
</head>
<body>
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="学生姓名" value="<?php echo ($info["stu_name"]); ?>" name="stu_name" id="stu_name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>毕设题目：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="毕设题目" value="<?php echo ($info["title"]); ?>" name="title" id="title">
			</div>
		</div>

		<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">论文等级：</label>
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
		<select class="select" name="deep_paper" size="1">
			<option value="">请选择论文等级</option>
			<option value="1" <?php if($info["deep_paper"] == 1): ?>selected='1'<?php endif; ?> >优秀</option>
			<option value="2" <?php if($info["deep_paper"] == 2): ?>selected='1'<?php endif; ?> >良好</option>
			<option value="3" <?php if($info["deep_paper"] == 3): ?>selected='1'<?php endif; ?> >合格</option>
			<option value="4" <?php if($info["deep_paper"] == 4): ?>selected='1'<?php endif; ?> >不合格</option>
			<!--<option value="3">栏目编辑</option>-->
		</select>
		</span> </div>
	</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>获得分数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="学生获得分数" value="<?php echo ($info["score"]); ?>" name="score" id="score">
			</div>
		</div>
		<div class="row cl">
