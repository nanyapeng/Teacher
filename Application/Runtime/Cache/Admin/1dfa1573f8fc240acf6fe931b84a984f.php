...
<title>添加科研信息 - H-ui.admin v3.1</title>
</head>
<body>
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>项目级别：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="科研项目级别（如，国家科研）" value="<?php echo ($info["deep"]); ?>" name="deep" id="deep">
			</div>
		</div>
		<div class="row cl">
