...
<title>添加荣誉称号信息 - H-ui.admin v3.1</title>
</head>
<body>
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if($_SESSION['u_name']== 'admmin'): ?><input type="text" class="input-text" value="<?php echo ($info["name"]); ?>" placeholder="课程教师" id="name" name="name">
				<?php else: ?>
				<input type="text" class="input-text" value="<?php echo (session('u_name')); ?>" disabled/>
				<input type="hidden" name="name" value="$Think.session.u_name"><?php endif; ?>			
			</div>
		</div>
		<input type="hidden" value="<?php echo ($info["id"]); ?>" name="id">

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>荣誉称号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="荣誉称号" value="<?php echo ($info["title"]); ?>" name="title" id="title">
			</div>
		</div>
		<div class="row cl">
