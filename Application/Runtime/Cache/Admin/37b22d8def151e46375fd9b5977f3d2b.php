...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="" method="post">
		...
		<div class="row cl">
			...
			<label class="form-label col-xs-4 col-sm-3">职称级别：</label>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>基础分数：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($info["base_score"]); ?>" placeholder="" id="base_score" name="base_score">
		</div>
	</div>
		<div class="row cl">
