...
class PHPExcel_Calculation {
	...
	//	PHPExcel.class functions
	private static $_PHPExcelFunctions = array(	// PHPExcel.class functions
	...
	private static function _loadLocales() {
		$localeFileDirectory = PHPEXCEL_ROOT.'PHPExcel.class/locale/';
	 ...
	 *
	 * @access	public
	 * @param   class $workbook  Injected workbook for working with a PHPExcel.class object,
	 ...
	 *
	 * @access	public
	 * @param   class $workbook  Injected workbook identifying the instance to unset
	 */
	...
	public function setLocale($locale = 'en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			if ($locale != 'en_us') {
				...
				$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel.class' .DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_',DIRECTORY_SEPARATOR,$locale).DIRECTORY_SEPARATOR.'functions';
				if (!file_exists($functionNamesFile)) {
					//	If there isn't a locale specific function file, look for a language specific function file
					$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel.class' .DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'functions';
					if (!file_exists($functionNamesFile)) {
						return FALSE;
					}
				}
				...
				$configFile = PHPEXCEL_ROOT . 'PHPExcel.class' .DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_',DIRECTORY_SEPARATOR,$locale).DIRECTORY_SEPARATOR.'config';
				if (!file_exists($configFile)) {
					$configFile = PHPEXCEL_ROOT . 'PHPExcel.class' .DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'config';
				}
				if (file_exists($configFile)) {
...
//echo 'PHPExcel.class function '.$functionName,PHP_EOL;
...
//					echo 'Token is a PHPExcel.class constant: '.$excelConstant.'<br />';
