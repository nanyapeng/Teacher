...
class PHPExcel_IOFactory
{
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => 'PHPExcel.class/Writer/{0}.php', 'class' => 'PHPExcel_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => 'PHPExcel.class/Reader/{0}.php', 'class' => 'PHPExcel_Reader_{0}' )
	);
	 ...
	 * @param	string $location	Example: PHPExcel.class/Writer/{0}.php
	...
	/**
	 * Loads PHPExcel.class from file using automatic PHPExcel_Reader_IReader resolution
	 *
	 * @static
	 * @access public
