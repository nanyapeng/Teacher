...
class PHPExcel_Settings
{
    ...
    /**
     * Set the Zip handler Class that PHPExcel.class should use for Zip file management (PCLZip or ZipArchive)
     *
     * @param string $zipClass	The Zip handler class that PHPExcel.class should use for Zip file management
    ...
    /**
     * Return the name of the Zip handler Class that PHPExcel.class is configured to use (PCLZip or ZipArchive)
     *	or Zip file management
     *
     * @return string Name of the Zip handler Class that PHPExcel.class is configured to use
    ...
    /**
     * Set details of the external library that PHPExcel.class should use for rendering charts
     *
    ...
    /**
     * Identify to PHPExcel.class the external library to use for rendering charts
     *
     * @param string $libraryName	Internal reference name of the library
     *	e.g. PHPExcel_Settings::CHART_RENDERER_JPGRAPH
     *
    ...
    /**
     * Tell PHPExcel.class where to find the external library to use for rendering charts
     *
     * @param string $libraryBaseDir	Directory path to the library's base folder
     * @return	boolean	Success or failure
     */
    ...
    /**
     * Return the Chart Rendering Library that PHPExcel.class is currently configured to use (e.g. jpgraph)
     *
     * @return string|NULL Internal reference name of the Chart Rendering Library that PHPExcel.class is
    ...
    /**
     * Return the directory path to the Chart Rendering Library that PHPExcel.class is currently configured to use
     *
     * @return string|NULL Directory Path to the Chart Rendering Library that PHPExcel.class is
     * 	currently configured to use
     */
    ...
    /**
     * Set details of the external library that PHPExcel.class should use for rendering PDF files
     *
     * @param string $libraryName Internal reference name of the library
    ...
    /**
     * Identify to PHPExcel.class the external library to use for rendering PDF files
     *
     * @param string $libraryName Internal reference name of the library
     * 	e.g. PHPExcel_Settings::PDF_RENDERER_TCPDF,
     *	PHPExcel_Settings::PDF_RENDERER_DOMPDF
    ...
    /**
     * Tell PHPExcel.class where to find the external library to use for rendering PDF files
     *
     * @param string $libraryBaseDir Directory path to the library's base folder
     * @return boolean Success or failure
     */
    ...
    /**
     * Return the PDF Rendering Library that PHPExcel.class is currently configured to use (e.g. dompdf)
     *
     * @return string|NULL Internal reference name of the PDF Rendering Library that PHPExcel.class is
     * 	currently configured to use
     *  e.g. PHPExcel_Settings::PDF_RENDERER_TCPDF,
     *  PHPExcel_Settings::PDF_RENDERER_DOMPDF
     *  or PHPExcel_Settings::PDF_RENDERER_MPDF
    ...
    /**
     * Return the directory path to the PDF Rendering Library that PHPExcel.class is currently configured to use
     *
     * @return string|NULL Directory Path to the PDF Rendering Library that PHPExcel.class is
     *		currently configured to use
     */
