...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     *
	 * @param 	class	$pPHPExcel
     */
    public function __construct(PHPExcel $pPHPExcel = null)
    {
    	// Assign PHPExcel.class
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			throw new PHPExcel_Writer_Exception("PHPExcel.class object unassigned.");
		}
	}

	/**
	 * Get PHPExcel.class object
	 *
	 * @return class
	 * @throws PHPExcel_Writer_Exception
	 */
	public function getPHPExcel() {
		if ($this->_spreadSheet !== null) {
			...
			throw new PHPExcel_Writer_Exception("No PHPExcel.class assigned.");
		}
	}

	/**
	 * Set PHPExcel.class object
	 *
	 * @param 	class 	$pPHPExcel	PHPExcel.class object
	 * @throws	PHPExcel_Writer_Exception
