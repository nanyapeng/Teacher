<?php
Vendor("PHPExcel.class.PHPExcel.class");//引入phpexcel类(注意你自己的路径)
Vendor("PHPExcel.class.PHPExcel.class.IOFactory");
// Vendor("PHPExcel.class.PHPExcel.class.Reader.Excel5");
// Vendor("PHPExcel.class.PHPExcel.class.Reader.Excel2007");
class ExcelReader {
    /**
     * 读取excel
