...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @param 	class							$pPHPExcel		Workbook
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class				$pPHPExcel
	 * @return 	PHPExcel_Style[]		All styles in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class							$pPHPExcel
	 * @return 	PHPExcel_Style_Conditional[]		All conditional styles in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class						$pPHPExcel
	 * @return 	PHPExcel_Style_Fill[]		All fills in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class						$pPHPExcel
	 * @return 	PHPExcel_Style_Font[]		All fonts in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class						$pPHPExcel
	 * @return 	PHPExcel_Style_Borders[]		All borders in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param 	class								$pPHPExcel
	 * @return 	PHPExcel_Style_NumberFormat[]		All number formats in PHPExcel.class
	 * @throws 	PHPExcel_Writer_Exception
	 */
