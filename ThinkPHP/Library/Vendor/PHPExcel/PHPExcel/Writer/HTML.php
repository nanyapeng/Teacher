...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	 ...
	 *
	 * @param	class	$phpExcel	PHPExcel.class object
	 */
	...
	public function generateHTMLHeader($pIncludeStyles = false) {
		// PHPExcel.class object known?
		if (is_null($this->_phpExcel)) {
			throw new PHPExcel_Writer_Exception('Internal PHPExcel.class object not set to an instance of an object.');
		}
		...
		$html .= '<!-- Generated by PHPExcel.class - http://www.phpexcel.net -->' . PHP_EOL;
		$html .= '<html>' . PHP_EOL;
		$html .= '  <head>' . PHP_EOL;
